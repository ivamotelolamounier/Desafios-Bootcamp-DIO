 ...
 * Cada operando ou operador é separado por um espaço em branco. A sequência de cada linha
 * que contém a expressão a ser lida é: número, caractere, número, caractere, número, caractere, número.
 ...
 *
 * Considerando N1 e D1 como numerador e denominador da primeira fração, segue a orientação de como
 * deverá ser realizada cada uma das operações:
 ...
 *
 * Entrada
 * A entrada contem vários casos de teste. A primeira linha de cada caso de teste contem
 * um inteiro N (1 ≤ N ≤ 1*104), indicando a quantidade de casos de teste que devem ser
 * lidos logo a seguir. Cada caso de teste contém um valor racional X (1 ≤ X ≤ 1000),
